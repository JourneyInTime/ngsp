"use strict";
/*
* If you can't find a specific skill on these list that probably means the preset file is outdated. 
* To update it just delete it and restart Tootbox to generate a new, updated file.
* If after following this process skills are still missing do report it on discord.
* About Retaliate emulation: it is fine to use if only pve is done, not so in pvp.
*/
/* eslint-disable quotes */

module.exports = {
	"*": { // Common
		"901": true, // Recall Home
		"902": true, // Racial Skill I
		"903": true, // Racial Skill II
	...
	"6": { // Priest
		...
		"5": true, // Blessing of Shakan, Seren, Balder, Zenobia and Arachne
		"6": true, // Arise
		...
		"41": true, // Divine Intervention / Mass Divine Intervention (Awakening)
		// Awakening
		"42": true, // Holy Burst
	...
	"8": { // Reaper
		...
		"23": false, // Binding Scythes (untested)
	},
	"9": { // Gunner
		"enabled": true,
		"1": true, // Blast
		...
		"40": true, // Rolling Reload / Dashing Reload
		// Awakening
		"41": true, // Modular Weapon System
		"42": true, // MWS: Detonate
		"43": true, // Remote Trigger
		"44": true, // MWS: Balder's Vengeance
		"47": true, // MWS: Obliteration
	},
	"10": { // Brawler
		"enabled": true,
		"1": true, // Punch
